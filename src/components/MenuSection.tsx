      ...
      try {
        ...
        const mappedProducts: MenuItem[] = prods
          ...
          .map(p => {
            ...
            // Normalize image path for Vercel/production compatibility
            let imgPath = p.gambar || "";
            if (imgPath.includes("/src/assets/images/")) {
              const filename = imgPath.split("/src/assets/images/").pop();
              imgPath = `/assets/images/${filename}`;
            } else if (imgPath.includes("/assets/images/")) {
              const filename = imgPath.split("/assets/images/").pop();
              imgPath = `/assets/images/${filename}`;
            }
