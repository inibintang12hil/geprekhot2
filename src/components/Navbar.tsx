      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Overlay Footer or branding */}
            <div className="p-8 text-center border-t border-red-50/50 bg-red-50/30">
              <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">GeprekHot &copy; 2026</p>
              <p className="text-[10px] text-gray-400 mt-1">Pedasnya Mantap, Harganya Sahabat!</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
